...
import { Bell, LogOut, Lock, Globe } from "lucide-react";
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <Card className="p-6 shadow-sm">
              ...
              <div className="space-y-0">
                <Button
                  variant="ghost"
                  className="w-full text-left py-6 px-4 hover:bg-background rounded-lg flex items-center justify-between group border-b h-auto"
                >
                  <div>
                ...
                <Button
                  variant="ghost"
                  className="w-full text-left py-6 px-4 hover:bg-background rounded-lg flex items-center justify-between group h-auto"
                >
                  <div>
                    <p className="font-semibold text-foreground">
